...
Semantic elemants give meaning to the content you are displaying on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display:block starts a new line and displa:inline doesnt respect height and starts elements inline, where the last element left off.
...
it allows a team of developers to work on the same project, make changes efficiently, review changes before committing, and version control (can rol back to a previous state).
